...
export const Former: React.FC<FormProps> = ({
  ...
  const onSubmit = async (data: FormValues) => {
    try {
      setLoading(true);
      if (initialData) {
        await axios.patch(`/${process.env.NEXT_PUBLIC_API_URL}/admin/users/${params.userId}`, data);
      } else {
            ...
            <FormField
              ...
              render={({ field }) => (
                <FormItem>
                  ...
                  <FormControl>
                    <Input disabled={loading} placeholder="UUID" {...field} />
                  </FormControl>
                  <FormMessage />
                </FormItem>
              )}
              ...
              render={({ field }) => (
                <FormItem className="flex flex-row items-start space-x-3 space-y-0 rounded-md border p-4 ">
                  ...
                  <div className="sapce-y-1 leading-none">
                    ...
                    <FormDescription>
                      Uncheck if you want the user to not have access to the store.
                    </FormDescription>
                  </div>
                </FormItem>
              )}
